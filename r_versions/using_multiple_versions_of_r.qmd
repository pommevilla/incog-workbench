...
You can also configure this on a per-user or per-group basis by specifying the `r-versions-multiple` option within [User and Group Profiles](../r_sessions/user_and_group_profiles.qmd).
