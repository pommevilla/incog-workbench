...
Executing this command will print an offline deactivation request to the terminal which you should copy and paste and enter into the [offline activation application](http://apps.rstudio.com/offline-activation) then send to RStudio customer support (<support@rstudio.com>).
