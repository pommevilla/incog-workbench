...
The section above describes how RStudio locates the global default version of R. It's also possible to specify alternate versions of R either by user or by group. The [R Versions](../r_versions/r_versions.qmd) section describes this in more detail.
