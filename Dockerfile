...
RUN R -e 'options(download.file.method = "wget"); install.packages("devtools", repos = "https://cran.rstudio.com"); devtools::install_github("rstudio/bookdown", ref = "ff13860382ab87d70977f634884c5d6830bb59c2")'
